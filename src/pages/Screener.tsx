    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-2 md:space-y-0">
        ...
        <Button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white rounded-md h-9 px-4"
        >
        ...
        <table className="min-w-full table-auto border-collapse text-sm">
          ...
          <tbody>
            {paginated.map((item, idx) => {
              const gainLossColor =
                item.price >= item.last_annual_dividend ? 'text-green-600' : 'text-red-600';
              ...
              return (
                ...
                >
                  ...
                  <td
                    className={`px-4 py-2 text-right font-semibold flex items-center justify-end ${gainLossColor}`}
                  >
